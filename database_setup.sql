--------------------------------------------------------
--  File created - Saturday-January-17-2026   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Table SIGNIN_UTILIZATOR
--------------------------------------------------------

  CREATE TABLE "SYSTEM"."SIGNIN_UTILIZATOR" 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008338" ON "SYSTEM"."REZERVARI" ("ID_REZ") 
  ...
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Index PK_UTILIZATOR
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."PK_UTILIZATOR" ON "SYSTEM"."SIGNIN_UTILIZATOR" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "SYSTEM" ;
--------------------------------------------------------
--  DDL for Procedure STERGE_REZERVARI_VECHI
--------------------------------------------------------
set define off;

  CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SYSTEM"."STERGE_REZERVARI_VECHI" AS
BEGIN
    -- Ștergem rezervările unde data este strict mai mică decât azi
    DELETE FROM REZERVARI 
    WHERE TRUNC(DATA_REZERVARE) < TRUNC(SYSDATE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REZERVARI" MODIFY ("ID_REZ" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."REZERVARI" ADD PRIMARY KEY ("ID_REZ")
...
--------------------------------------------------------
--  Constraints for Table SIGNIN_UTILIZATOR
--------------------------------------------------------

  ALTER TABLE "SYSTEM"."SIGNIN_UTILIZATOR" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SIGNIN_UTILIZATOR" MODIFY ("USERNAME" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SIGNIN_UTILIZATOR" MODIFY ("PAROLA" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."SIGNIN_UTILIZATOR" ADD CONSTRAINT "PK_UTILIZATOR" PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."REZERVARI" ADD CONSTRAINT "FK_USER" FOREIGN KEY ("USER_ID")
	  REFERENCES "SYSTEM"."SIGNIN_UTILIZATOR" ("ID") ENABLE;

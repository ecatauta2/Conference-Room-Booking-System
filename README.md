...
| *Overview of available rooms and daily stats* |


| **Room Details & Map** |
|:---:|
| ![Room Details](screenshots/room_details.png) |
| *Specific amenities and location on map* |


| **Reservation Process** |
|:---:|
| ![Booking](screenshots/booking.png) |
| *Selecting a date for the event* | 


|**My Reservations (User Specific)** |
|:---:|
|![My Reservations](screenshots/my_reservations.png) |
| *Personalized list of booked slots* |
